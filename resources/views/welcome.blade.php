                                    ...
                                    <ul class="nav">
                                        <div id="akagali-nav" class="collapse navbar-collapse" >
                                            <ul class="nav navbar-nav navbar-right" style=" width:auto;background:#fff;">
                                                ...
                                                @guest
                                                    <li><a href="{{ route('login') }}" style="color: #fff; width:auto;background:#079c0d; " title="Kwinjira bigufasha kuba waganira n'abandi." >Kwinjira</a></li>
                                                    <li><a href="{{ route('register') }}" style="color:#fff; width:auto;background:#079c0d;margin-left: 2px" title="Kwiyandikisha bituma abo muri kuganira bamenya uwo uri we.">Kwiyandkisha</a></li>
                                                @endguest
                                            </ul>
                                        </div>
                                    </ul>
