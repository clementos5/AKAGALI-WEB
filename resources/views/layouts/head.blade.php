        ...
        <div class="header">
            <header>
                <div class="akagali-navbar">
                                    ...
                                    <ul class="nav">
                                        <div id="akagali-nav" class="collapse navbar-collapse" >
                                            <ul class="nav navbar-nav navbar-right" style="width: 30%;">
                                                ...
                                                @guest
                                                    <li><a href="{{ route('login') }}" >Injira</a></li>
                                                    <li><a href="{{ route('register') }}">Iyandikishe</a></li>
                                                @else
                                                <div class="dropdown">
                    ...
                    <!--overview start-->
            @if(Auth::user() AND Auth::user()->user_type == 'admin')
              <div id="getFixed">
                  <section class="panel">
              ...
              <div class="akagali-content-left">
                    ...
                    <div class="col-xs-12">
                      <table class="table">
                        @if(count($services) != 0)
                            ...
                            @endforeach
                        @else
                          <div style="color: red"> Mutwihanganire, Nta gahunda nshya zibashije kuboneka <a href="/suggestions/suggest/{{$cell_id}}">Kanda Hano Uduhe Igitekerezo</a></div>
                        @endif
                ...
                <div class="amatangazo">
                  @if(count($action_plans) != 0)
                    @foreach($action_plans AS $plan)
                      <div class="col-xs-12">
                        ...
                        <div class="col-md-12" style="padding-bottom: 5px;">
                          {{$plan->year}} | <a href="/{{$plan->plan_url}}">Kuyifungura/Kuyibika</a>
                        </div>
                    ...
                    @endforeach
                  @else
                    <div class="col-xs-12" style="color: red"> Mutwihanganire, Igenabikorwa riratangazwa bidatinze <a href="/suggestions/suggest/{{$cell_id}}">Kanda Hano Uduhe Igitekerezo</a></div>
                  @endif
                </div>
              </div>
            @endif
